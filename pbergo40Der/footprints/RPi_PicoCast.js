...
module.exports = {
  params: {
    ...
    ACVREF: {type: 'net', value: 'ACVREF'},
    V3EN: {type: 'net', value: 'V3EN'},
  ...
  body: p => {
    ...
    function pins() {
      return `
        ...
        (pad "1" smd rect (at -8.89 -24.13) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP0.str})
        (pad "2" thru_hole oval (at -8.89 -21.59) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP1.str})
        (pad "2" smd rect (at -8.89 -21.59) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP1.str})
        (pad "3" smd rect (at -8.89 -19.05) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        ...
        (pad "4" smd rect (at -8.89 -16.51) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP2.str})
        (pad "5" thru_hole oval (at -8.89 -13.97) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask)  ${p.GP3.str})
        (pad "5" smd rect (at -8.89 -13.97) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP3.str})
        (pad "6" thru_hole oval (at -8.89 -11.43) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP4.str})
        (pad "6" smd rect (at -8.89 -11.43) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP4.str})
        (pad "7" smd rect (at -8.89 -8.89) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP5.str})
        ...
        (pad "8" smd rect (at -8.89 -6.35) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "9" smd rect (at -8.89 -3.81) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP6.str})
        (pad "9" thru_hole oval (at -8.89 -3.81) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP6.str})
        (pad "10" thru_hole oval (at -8.89 -1.27) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP7.str})
        (pad "10" smd rect (at -8.89 -1.27) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP7.str})
        (pad "11" smd rect (at -8.89 1.27) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP8.str})
        (pad "11" thru_hole oval (at -8.89 1.27) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask)  ${p.GP8.str})
        (pad "12" thru_hole oval (at -8.89 3.81) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP9.str})
        (pad "12" smd rect (at -8.89 3.81) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask)  ${p.GP9.str})
        (pad "13" thru_hole rect (at -8.89 6.35) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "13" smd rect (at -8.89 6.35) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "14" smd rect (at -8.89 8.89) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask)  ${p.GP10.str})
        ...
        (pad "15" smd rect (at -8.89 11.43) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP11.str})
        (pad "16" smd rect (at -8.89 13.97) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP12.str})
        (pad "16" thru_hole oval (at -8.89 13.97) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP12.str})
        (pad "17" smd rect (at -8.89 16.51) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP13.str})
        (pad "17" thru_hole oval (at -8.89 16.51) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP13.str})
        (pad "18" smd rect (at -8.89 19.05) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask)  ${p.GND.str})
        ...
        (pad "19" smd rect (at -8.89 21.59) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP14.str})
        (pad "20" smd rect (at -8.89 24.13) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP15.str})
        (pad "20" thru_hole oval (at -8.89 24.13) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP15.str})
        (pad "21" smd rect (at 8.89 24.13) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP16.str})
        (pad "21" thru_hole oval (at 8.89 24.13) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP16.str})
        (pad "22" smd rect (at 8.89 21.59) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP17.str})
        (pad "22" thru_hole oval (at 8.89 21.59) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask)  ${p.GP17.str})
        (pad "23" smd rect (at 8.89 19.05) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask)  ${p.GND.str})
        ...
        (pad "24" smd rect (at 8.89 16.51) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP18.str})
        (pad "25" smd rect (at 8.89 13.97) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP19.str})
        (pad "25" thru_hole oval (at 8.89 13.97) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP19.str})
        (pad "26" smd rect (at 8.89 11.43) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP20.str})
        ...
        (pad "27" smd rect (at 8.89 8.89) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask)  ${p.GP21.str})
        (pad "28" thru_hole rect (at 8.89 6.35) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "28" smd rect (at 8.89 6.35) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "29" thru_hole oval (at 8.89 3.81) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP22.str})
        (pad "29" smd rect (at 8.89 3.81) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP22.str})
        (pad "30" smd rect (at 8.89 1.27) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.RUN.str})
        (pad "30" thru_hole oval (at 8.89 1.27) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.RUN.str})
        (pad "31" thru_hole oval (at 8.89 -1.27) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP26.str})
        (pad "31" smd rect (at 8.89 -1.27) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP26.str})
        (pad "32" thru_hole oval (at 8.89 -3.81) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP27.str})
        (pad "32" smd rect (at 8.89 -3.81) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP27.str})
        (pad "33" smd rect (at 8.89 -6.35) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "33" thru_hole rect (at 8.89 -6.35) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "34" smd rect (at 8.89 -8.89) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GP28.str})
        (pad "34" thru_hole oval (at 8.89 -8.89) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GP28.str})
        (pad "35" smd rect (at 8.89 -11.43) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.ACVREF.str})
        (pad "35" thru_hole oval (at 8.89 -11.43) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.ACVREF.str})
        (pad "36" thru_hole oval (at 8.89 -13.97) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.V3.str})
        (pad "36" smd rect (at 8.89 -13.97) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.V3.str})
        (pad "37" smd rect (at 8.89 -16.51) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.V3EN.str})
        (pad "37" thru_hole oval (at 8.89 -16.51) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.V3EN.str})
        (pad "38" smd rect (at 8.89 -19.05) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "38" thru_hole rect (at 8.89 -19.05) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "39" smd rect (at 8.89 -21.59) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.VSYS.str})
        (pad "39" thru_hole oval (at 8.89 -21.59) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.VSYS.str})
        (pad "40" thru_hole oval (at 8.89 -24.13) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.VBUS.str})
        (pad "40" smd rect (at 8.89 -24.13) (size 3.5 1.7) (drill (offset 0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.VBUS.str})
        (pad "41" smd rect (at -2.54 23.9 90) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.SWCLK.str})
        (pad "41" thru_hole oval (at -2.54 23.9) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.SWCLK.str})
        (pad "42" thru_hole rect (at 0 23.9) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "42" smd rect (at 0 23.9 90) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.GND.str})
        (pad "43" thru_hole oval (at 2.54 23.9) (size 1.7 1.7) (drill 1.02) (layers *.Cu *.SilkS *.Mask) ${p.SWDIO.str})
        (pad "43" smd rect (at 2.54 23.9 90) (size 3.5 1.7) (drill (offset -0.9 0)) (layers *.Cu *.SilkS *.Mask) ${p.SWDIO.str})      `
    }
    return `
        ${standard}
        ${pins()})
