  ...
  body: p => {
    ...
    `
      function pins() {
        return `
        ${''/* pin names */}
        (fp_text user P1 (at 0 0) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P0 (at -2.77 0) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P2 (at -5.54 0) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P3 (at -8.31 0) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P4 (at -11.08 0) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P5 (at -1.385 2.84) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P6 (at -4.155 2.84) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P7 (at -6.925 2.84) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P8 (at -9.695 2.84 (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user P9 (at -18.04 0.3) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        (fp_text user PA (at 6.96 0.3) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        ...
        (pad 0 thru_hole circle (at -18.04 0.3) (size 4 4) (drill 3.2) (layers *.Cu *.SilkS *.Mask) ${p.PA.str})
        (pad A thru_hole circle (at 6.96 0.3) (size 4 4) (drill 3.2) (layers *.Cu *.SilkS *.Mask) ${p.PA.str})
      `
    }
      return `
        ${standard}
